...
export default {
    ...
    let list,total,countList,countObj,countAll,oriList;
        let {data:{code,data,totalRecord}} = await axios.post('https://enapi.goldenunionassets.com/article/search',{data:params.search.trim(),start:0,limit:1000});
        if(code == 0){
            oriList = list = data;
            total = totalRecord;
        }
	    let {data:{code:code2,data:data2}} = await axios.post('https://enapi.goldenunionassets.com/article/search/count',{data:params.search.trim()});
        if(code2 == 0){
            countList = data2;
            countAll = 0;
            countObj = {};
    ...
    methods:{
        ...
        async toSearch(){
            ...
            let {data:{code,data}} = await axios.post('https://enapi.goldenunionassets.com/article/search',{data:searchKey,start:0,limit:1000});
            if(code == 0){
                oriList = list = data;
            }
            let {data:{code:code2,data:data2}} = await axios.post('https://enapi.goldenunionassets.com/article/search/count',{data:searchKey});
            if(code2 == 0){
                countList = data2;
                countAll = 0;
                countObj = {};
