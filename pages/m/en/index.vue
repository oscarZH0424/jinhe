...
export default {
  async  asyncData ({ params }) {//请求
    ...
    let {data:{code:code2,data:data2}} = await axios.post('https://enapi.goldenunionassets.com/banner/screen',{data:{status:true,belong:'home',types:['mobile']},start:0,limit:1000});
    if(code2 == 0){
     banners = data2;
    }
