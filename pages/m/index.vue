  ...
  <div class="container">
    ...
    <div class="desc-panel" id="glgm">
      ...
      <div class="desc-info p2 wow fadeInUp" data-wow-delay="2s">
        <div class="desc-title" style="margin-bottom:50px;">{{configObj[2].text || '锦和资管的管理规模'}}</div>
    ...
    <div class="desc-panel" id="syms">
      ...
      <div class="desc-info p4 wow fadeInUp" data-wow-delay="2s">
        <div class="desc-title" style="margin-bottom:10px;">{{configObj[5].text || '锦和资管的商业模式'}}</div>
        <div class="desc-subtitle" style="margin-bottom:33px;">{{configObj[5].text1 || '锦和资管全生命周期管控系'}}<br>{{configObj[5].text2 || '“一站式”资产管理服务'}}</div>
        <div class="tag-group">
          <div class="tag-item">
    ...
    <div class="desc-panel" id="yyys">
      ...
      <div class="desc-dark">
        <div class="wow fadeInUp">
          <div class="desc-title" style="margin-bottom:40px;margin-top:80px;">{{configObj[6].text || '锦和资管的运营优势'}}</div>
          <div class="desc-intro-group">
            <div class="desc-intro-item">
